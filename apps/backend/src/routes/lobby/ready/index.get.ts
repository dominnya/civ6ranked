...
const reply400 = type({
  message: "'VALIDATION_ERROR' | 'UNKNOWN_LOBBY_ERROR' | 'NO_AVAILABLE_MACHINE' | 'NOT_IN_LOBBY' | 'NOT_OWNER' | 'LOBBY_NOT_FOUND'",
});
...
export default define()
  .meta({
    path: '/lobby/ready',
    method: 'get',
    summary: 'Get ready task status',
    description: 'Get the status of a ready task',
    tags: ['Lobby', 'Ready'],
